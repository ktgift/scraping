...
export async function GET() {
    try {
        ...
        console.log('.movie-card selector found!');
        ...
        const movies: { title: string; date: string; imageUrl: string, ref: string }[] = [];

        console.log(`Searching for movie elements in ${$('.display-post-story').find('div')} items...`);
